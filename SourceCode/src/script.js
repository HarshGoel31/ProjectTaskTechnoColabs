...
var codeIds = ['es5-one-code', 'es5-two-code', 'es5-three-code', 'es5-four-code'];
var percentIds = ['es5-one-percent', 'es5-two-percent', 'es5-three-percent', 'es5-four-percent'];

var codeBlocks = ['\n\nvar nurseOlynyk = ...', '\n\nvar nurseDurant = ...', '\n\nvar myString = \'str\' + x', 'var HospitalEmployee = \n  function () {\n    function \n    HospitalEmployee(name) {\n...'];
